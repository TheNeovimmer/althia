        ...
        <?php if (!empty($conversations)): ?>
            <div class="conversation-list">
                <?php foreach ($conversations as $conv): ?>
                    <a href="/doctor/messages/conversation/<?= $conv['partner_id'] ?? $conv['sender_id'] ?>" class="conversation-item <?= ($conv['unread_count'] ?? 0) > 0 ? 'unread' : '' ?>">
                        ...
                        <div class="conv-content">
                            <strong><?= htmlspecialchars($conv['first_name'] . ' ' . $conv['last_name']) ?></strong>
    ...
    <div class="modal-content form-card" style="max-width:500px;margin:auto;padding:24px;border-radius:16px;">
        ...
        <form method="POST" action="/doctor/messages">
            ...
            <div class="form-group">
                <label for="receiver_id">Patient</label>
