        ...
        <div class="msg-inbox">
            <?php if (!empty($conversations)): ?>
                <?php foreach ($conversations as $conv): ?>
                    <?php
                        ...
                        $name = 'Dr. ' . htmlspecialchars($conv['first_name'] . ' ' . $conv['last_name']);
                    ...
                    ?>
                    <a href="/patient/messages/conversation/<?= $partnerId ?>" class="msg-row <?= $unread > 0 ? 'msg-unread' : '' ?>">
            ...
            <?php else: ?>
                <div class="empty-state-enhanced">
                    ...
                    <p>Start a conversation with one of your doctors.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="modal-panel">
        ...
        <form method="POST" action="/patient/messages/send">
            ...
            <div class="form-group">
                <label class="form-label" for="receiver_id"><i class="fas fa-user-md"></i> Doctor</label>
